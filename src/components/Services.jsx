...
import { User, MapPin, Phone, ShieldCheck, Lock, Search, RefreshCw } from 'lucide-react';
...
const Services = () => {
  ...
  const fetchData = async (pageNum = 1, append = false) => {
    try {
      ...
      // Fetch categories only initially
  ...
  return (
    <section id="services" className="services">
      <div className="section-container">
        <h2 className="heading-title">Explore <span className="text-primary">Skilled Professionals</span></h2>
        <p className="heading-subtitle">Verified experts and community contributors</p>
        ...
        <div className="professionals-grid">
          {loading ? (
             // Show 6 skeletons while main initial loading
